...
def get_town(string):                                                                                     #四级地址
	pattern = re.compile(r'(.*?[镇乡])|(.*?街道)')
	result = pattern.search(string)
	if result == None:
		return ' '
	return result.group(0)

def get_road(string):                                                                                      #五级地址
...
#-----------------------------------------------------------------------------------------姓名
    ...
    #print(nstring)
#-----------------------------------------------------------------------------------------电话
	telnum=get_phonenumber(nstring)
    #print(telnum)
	address=del_(nstring,telnum)
    #print (address)
#-----------------------------------------------------------------------------------------一级
...
#-----------------------------------------------------------------------------------三级
	...
	address = cutdown(address,area)
#print(area)
#print(address)
 #----------------------------------------------------------------------------------四级
	town=get_town(address)
	address=cutdown(address,town)
#print(town)
#print(address)
	ADDR={}
	ADDR["姓名"] = name
	...
	if grade=='1': #----------------------------------------------------------------------------------五级
		...
		road = get_road(address)
		address=cutdown(address,road)
		#print(road)
		#print(address)
		addr.append(road)
	#-----------------------------------------------------------------------------------七级
		housenum=get_housenum(address)
		address=cutdown(address,housenum)
		addr.append(housenum)
		addr.append(address)
	ADDR["地址"]=addr
	print(json.dumps(ADDR,ensure_ascii=False))
